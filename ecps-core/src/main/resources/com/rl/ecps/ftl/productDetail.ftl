...
<head>
    ...
    <script type="text/javascript" src="${path}/res/shop/index.js"></script>
    <script type="text/javascript" src="${path}/res/shop/ajaxStaturs.js"></script>
    <script type="text/javascript" src="${path}/res/shop/productDetail.js"></script>
</head>
<body>
...
<div class="w nav">
    <ul class="uls">
        ...
        <li><a href="${path}/item/toIndex.do" title="首页" class="a"><b>首页</b></a></li>
    </ul>
</div>
...
<div class="w loc">
    ...
    <p class="l"><a href="${path}/item/toIndex.do" title="商城首页">商城首页</a>
        <samp>|</samp><a href="${path}/user/login/toPersson.do" title="我的商城">我的商城</a></p>
    ...
    <p class="r"><a href="${path}/item/toIndex.do" title="商城首页">商城首页</a><samp>&gt;</samp><a href="#"
                                                                               title="手机商城">手机商城</a><samp>&gt;</samp><a
                href="#" title="HTC">HTC</a><samp>&gt;</samp><span class="gray">HTC A6390</span></p>
...
<div class="w ofc mt">
    ...
    <div class="r wr">
        ...
        <div class="product">
            ...
            <div class="showPro">
                <div class="big">
                    <a id="showImg" class="cloud-zoom" href="${upload_file_path}${item.imgs}"
                       rel="adjustX:10,adjustY:-1">
                        <img title="optional title display" alt="" src="${upload_file_path}${item.imgs}"></a></div>
                <div class="big_type">团购中...</div>
                <div class="small">
                    <span class="smallL" title="向左">&nbsp</span>
                    <div class="smallBox">
                        <div class="smallList">
                            <a class="cloud-zoom-gallery here" title="red" href="${upload_file_path}${item.imgs}"
                               rel="useZoom: 'showImg', smallImage: '${upload_file_path}${item.imgs}'"><img
                                        alt="thumbnail 1" src="${upload_file_path}${item.imgs}"></a>
                            <a class="cloud-zoom-gallery" title="blue" href="${upload_file_path}${item.imgs}"
                               rel="useZoom: 'showImg', smallImage: '${upload_file_path}${item.imgs}'"><img
                                        alt="thumbnail 2" src="${upload_file_path}${item.imgs}"></a>
                            <a class="cloud-zoom-gallery" title="blue" href="${upload_file_path}${item.imgs}"
                               rel="useZoom: 'showImg', smallImage: '${upload_file_path}${item.imgs}'"><img
                                        alt="thumbnail 3" src="${upload_file_path}${item.imgs}"></a>
                            <a class="cloud-zoom-gallery" title="blue" href="${upload_file_path}${item.imgs}"
                               rel="useZoom: 'showImg', smallImage: '${upload_file_path}${item.imgs}'"><img
                                        alt="thumbnail 4" src="${upload_file_path}${item.imgs}"></a>
                            <a class="cloud-zoom-gallery" title="blue" href="${upload_file_path}${item.imgs}"
                               rel="useZoom: 'showImg', smallImage: '${upload_file_path}${item.imgs}'"><img
                                        alt="thumbnail 5" src="${upload_file_path}${item.imgs}"></a>
                        </div>
                    </div>
            ...
            <form method="post" action="" name="" class="infor">
                <ul class="uls form">
                    ...
                    <li>
                        <label>移 动 价：</label>
                        <span class="word">
                            <b class="f14 red mr" id="skuPrice">￥3999.00</b>(市场价:<del id="marketPrice">￥5789.00</del>)
                        </span>
                    </li>

                    <li>
                        <label>商品编号：</label>
                        <span class="word">LJ93756</span>
                    </li>

                    <li>
                        <label>商品评价：</label>
                        <span class="word">
                            <span class="val_no val3d4" title="4分">4分</span>
                            <var class="blue">(已有17人评价)</var>
                        </span>
                    </li>

                    <li>
                        <label>运　　费：</label>
                        <span class="word">包邮&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" class="blue">配送区域</a></span>
                    </li>

                    <li>
                        <label>库　　存：</label>
                        <span class="word" id="stockInventory">有货</span>
                    </li>
                ...
                <div class="box_orange">
                    <ul class="uls form">
                        <li>
                            ...
                            <div class="pre spec">
                                <#list item.skuList as sku>
                                    <#if sku_index=0>
                                        <a class="here" skuId="${sku.skuId?c}">
                        ...
                        <li>
                            ...
                            <input readonly type="text" name="quantity" id="quantity"  value="1" class="num" size="3"/>
                            <a href="javascript:void(0);" class="inb add"></a>
                            <em id="sub_add_msg" class="red"></em>
                        </li>

                        <li class="submit">
                            <input type="button" value="" class="hand btn138x40" id="meBuy" onclick="buy();"/>
                            <input type="button" value="" class="hand btn138x40b" id="meCart" onclick="addCart()"/>
            ...
            <div id="detailTab2" style="display:none">
                <table cellspacing="0" summary="" class="tab tab7">
                    ...
                    <#list item.paraList as paraVal >
                        <tr>
                            <th width="15%" class="alg_r">${paraVal.featureName}</th>
