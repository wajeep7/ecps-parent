...
<ul class="ul">
    <li><a href="${path}/item/toList.do?auditStatus=1&showStatus=1"><samp class="t05"></samp>商品录入/上下架</a></li>
    <li><a href="${path}/item/toListAudit.do"><samp class="t05"></samp>商品审核</a></li>
