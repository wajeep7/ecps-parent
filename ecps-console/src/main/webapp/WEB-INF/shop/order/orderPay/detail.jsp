...
<div class="frameR">
    <div class="content">
        ...
        <form id="myForm" action="${path}/order/orderPay/oper.do"
            ...
            <div class="sch page_c">
						<span class="l">订单号：<b class="red"><var>${tb.order.orderNum}</var></b>&nbsp;&nbsp;&nbsp;下单时间：
							<var><fmt:formatDate value="${tb.order.orderTime}" pattern="yyyy-MM-dd HH:mm:ss"/></var>


							<c:if test="${tb.order.orderState == 1 }">
	...
	<a href="javascript:void(0);" ref="#tab_3" title="操作记录" class="nor">操作记录</a>
                ...
                <span class="r">
		<input type="button" class="pointer"
               onclick="window.open('${base}/order/preview.do?orderId=${tb.order.orderId}&type=15','_blank','height=300,width=500,scrollbars=yes,location=no,resizable=yes')"
               value="打印订单"/>
			<input type="button" class="pointer" onclick="window.history.back(-1);" value="返回列表"/></span>
            </h2>
            ...
            <div id="tab_1">
                ...
                <table cellspacing="0" summary="" class="tab4">
                    ...
                    <tr>
                        ...
                        <td class="nwp" colspan="5">
                            ${tb.order.prevText}&nbsp;${tb.order.cityText}&nbsp;${tb.order.distText}
                            <c:out value="${tb.order.addr}"/>
                        </td>
                    </tr>
                    <tr>
                        <th>用户备注:</th>
                ...
                <table cellspacing="0" summary="" class="tab3">
                    ...
                    <c:forEach items="${tb.order.orderDetailList}" var="orderDetail">
                        <tr>
                ...
                <!-- 金额合计 -->
                <div class="page_c">
			<span class="r">商品金额合计：${td.order.orderSum }元&nbsp;&nbsp;&nbsp;
            ...
            <div id="tab_2" style="display: none">
                <table cellspacing="0" summary="" class="tab3">
                    <tr>
                        ...
                        <td>${tb.order.orderDetailList.payRecordNum}</td>
                    </tr>
                    <tr>
                        <th width="12%">支付方式：</th>
                        <td>
                    ...
                    <%--
                            <tr><th width="12%">支付平台：</th><td>${tb.order.orderDetailList.poName}</td></tr>
                    --%>
                    <tr>
                        <th width="12%">支付金额：</th>
                        <td><fmt:formatNumber value="${tb.order.orderSum/100}" pattern="#0.00"/>元</td>
                    </tr>
                    <tr>
                        <th width="12%">支付状态：</th>
                        <td>
                    ...
                    <tr>
                        <th width="12%">付款时间：</th>
                        <td><var><fmt:formatDate value="${tb.order.payTime}" pattern="yyyy-MM-dd HH:mm:ss"/></var></td>
                    </tr>
                    <tr>
                        <th width="12%">到账时间：</th>
                        <td><var><fmt:formatDate value="${tb.order.depositTime}" pattern="yyyy-MM-dd"/></var></td>
                    </tr>
                </table>
            </div>
