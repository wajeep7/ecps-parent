...
<head>
	...
	<script type="text/javascript" src="${path}/ecps/console/res/item/addbrand.js"></script>
...
<div class="frameR">
	<div class="content">
		...
		<div class="loc icon">
			<samp class="t12"></samp>
			当前位置：商品管理&nbsp;&raquo;&nbsp;<a
				href="<c:url value="${pageContext.request.contextPath}/item/addBrand.do"/>"
				title="品牌管理">品牌管理</a>&nbsp;&raquo;&nbsp;<span class="gray">添加品牌</span>
			<a href="<c:url value="/item/ListBrand.do"/>"
			...
			<div class="edit set">
				...
				<p>
					<label class="alg_t"><samp>*</samp>品牌LOGO：</label><img
						alt="" id='imgsImgSrc' src="" height="100" width="100" />
				</p>
				<p>
