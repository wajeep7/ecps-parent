...
<script src="${path}/res/js/com.js" type="text/javascript"></script>
	<script type="text/javascript" src="${path}/res/shop/passport/login.js"></script>
...
<div class="w loc">
	...
	<p class="r"><a href="${path}/item/toIndex.do" title="首页">首页</a><samp>&gt;</samp><span class="gray">登录移动商城</span></p>
	...
	<div class="r">
		...
		<form id="jvForm" action="${path}/user/Login.do" method="post">
			...
			<li><label for="captcha">验证码：</label>
				...
				<img src="${path}/user/getImage.do" id="capachaImg" onclick="getCaptcha();" class="code" alt="换一张" />
				<a href="javascript:void(0);" onclick="getCaptcha();" title="换一张">换一张</a></li>
			<li class="gray"><label for="">&nbsp;</label><input type="checkbox" name="" />30天内免登录（公共电脑勿用）</li>
			<li><label for="">&nbsp;</label><input type="submit" value="登 录" class="hand btn66x23"/>
