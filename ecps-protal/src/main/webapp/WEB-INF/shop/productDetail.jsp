...
<div class="w loc">
    ...
    <p class="l"><a href="${path}/item/toIndex.do" title="商城首页">商城首页</a><samp>|</samp><a href="#" title="我的商城">我的商城</a></p>
    ...
    <p class="r"><a href="index.html" title="商城首页">商城首页</a><samp>&gt;</samp><a href="#"
                ...
                <div class="box_orange">
                    <ul class="uls form">
                        <li>
                            <label>规　　格：</label>
                            <div class="pre spec">
                                <c:forEach var="sku" items="${item.skuList}" varStatus="state">
                                    <c:choose>
                                        <c:when test="${state.index == 0}">
                                            <a class="here" skuId="${sku.skuId}">
                                                <c:forEach var="spec" items="${sku.specList}">
                                                    ${spec.specValue}
                                                </c:forEach>
                                            </a>
                                        </c:when>
        ...
        <div class="box bg_white ofc">
            ...
            <div id="detailTab2" style="display:none">
                <table cellspacing="0" summary="" class="tab tab7">
                    ...
                    <tbody>
                    <c:forEach var="paraVal" items="${item.paraList}">
                        <tr>
