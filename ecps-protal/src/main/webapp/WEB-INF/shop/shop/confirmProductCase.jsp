...
<form action="${path}/order/SubmitOrder.do" method="post">
    ...
    <div class="w ofc case">
        ...
        <div class="box bg_white pb">
            ...
            <dl class="distr">
                ...
                <dd class="box_d bg_gray2 ofc">
                    <ul class="uls form">
                        <li><label for="deliveryTime">送货时间：</label><input type="radio" name="delivery" value="3"
                                                                          checked="checked"/>只工作日送货（双休日，节假日不送）
                        </li>
                        ...
                        <li><label>送货前电话确认：</label><input type="radio" name="isConfirm" value="1"/>是&nbsp;&nbsp;<input
                                type="radio" name="isConfirm" checked="checked" value="0"/>否
                        </li>
                        <li id="modeLi02" style="display:none"><label>付款方式：</label>
                            <input type="checkbox" name="paymentCash" value="1"/>现金&nbsp;&nbsp;
                            <input type="checkbox" name="paymentCash" value="2"/>POS刷卡&nbsp;&nbsp;
                            <input type="checkbox" name="paymentCash" value="3"/>支票
                        </li>
                    </ul>
                </dd>
        ...
        <div class="box bg_white">
                ...
                <dd>
                    ...
                    <div class="box_d bg_gray2 ofc">
                        <table cellspacing="0" summary="" id="adrList" class="tab">
                            <c:forEach var="shipAddr" items="${addrList}">
                                <tr>
                                    <td colspan="4">
                                        <input type="radio" value="${shipAddr.shipAddrId}" name="address" id="address"
                                               <c:if test="${shipAddr.defaultAddr==1}">checked='checked'</c:if>/>
                                            ${shipAddr.shipName}&nbsp;${shipAddr.prevText}&nbsp;${shipAddr.cityText}&nbsp;${shipAddr.distText}
                                        &nbsp;${shipAddr.zipCode}&nbsp;${shipAddr.phone}
                                    </td>
                                </tr>
                            </c:forEach>
            ...
            <ul id="addAddress" class="uls form" style="display:none">
                <li>
                    ...
                    <span class="bg_text">
                        <input type="text" id="username" name="shipName" vld="{required:true}" maxLength="100" class="txt"/>
                    </span>
                    <span class="pos">
                ...
                <li>
                    <label for="addr">街道地址：</label>
                    <span class="bg_text">
                        <input type="text" id="addr" name="addr" maxLength="32" vld="{required:true}" class="txt"/>
                    </span>
                    <span class="pos">
                ...
                <li>
                    ...
                    <span class="bg_text">
				<input type="text" id="zipCode" name="zipCode" maxLength="32" vld="{required:true}" class="txt"/>
			</span>
                </li>

                <li><label for="phone">联系电话：</label>
                    <span class="bg_text">
				<input type="text" id="phone" name="phone" maxLength="32" vld="{required:true}" class="txt gray"
                       value="请输入手机号码或者固定电话"/>
			</span>
                    <span class="pos">
				<span class="tip warningTip">用户名为4-20位字母、数字或中文组成，字母区分大小写。</span>
			</span>
                </li>
            </ul>
        </div>
                ...
                <dd>
                    <table cellspacing="0" summary="" class="tab">
                        ...
                        <tr>
                            ...
                            <td class="gray">即时到帐，支持绝大数银行借记卡及部分银行信用卡；<samp id="openBank" title="请点击查看支持那些银行。"
                                                                           class="default">[+]请点击查看支持那些银行。</samp></td>
                        </tr>
                    </table>
                ...
                <dd class="box_d bg_gray2 ofc" style="display:none">
                    <ul class="uls form">
                        ...
                        <li><label for="">发票抬头：</label><span class="bg_text"><input type="text" id="invoiceNick"
                                                                                    ...
                                                                                    vld="{required:true}" class="txt"
                                                                                    value="亚信联创科技(中国)有限公司"/></span></li>
        ...
        <div class="box bg_white pb">
            ...
            <table cellspacing="0" summary="" class="tab tab4">
                ...
                <c:forEach var="cart" items="${cartList}">
                    ...
                    <td class="img48x20">
                        <span class="inb"><img src="${upload_file_path}${cart.sku.item.imgs}"/></span>
                    ...
                    <td>${cart.quantity }</td>
                    <td class="orange">￥${cart.quantity *cart.sku.skuPrice}</td>
                </tr>
                <tr>
        ...
        <%--库 orderNum 商品总金额 信息--%>
        <input type="hidden" id="orderSum" name="orderSum" value="${totalPrice}">
        <div class="confirm mt">
            ...
            <div class="ofc">
                ...
                <div class="r">
                    <input type="hidden" name="buyType" value="${totalPrice}"/>
                    <c:if test="${temp==null }">
                        <input id="d1" type="hidden" name="d1" value="1"/>
                    </c:if>
                    <dl class="total">

                        <dt>最终订单金额：<cite>(共<var id="totalNum"><c:out value="${totalNum }"/></var>个商品)</cite></dt>
                        <dd><em class="l">商品金额：</em>￥<var><fmt:formatNumber value="${totalPrice}"
                                                                            pattern="#0.00"/></var></dd>
                        <dd><em class="l">运费：</em>￥<var><c:out value="0.00"/></var></dd>
                        <dd class="orange"><em class="l">应付总额：</em>￥<var id="totalMoney"><fmt:formatNumber
                                value="${totalPrice}" pattern="#0.00"/></var></dd>
                        <dd class="alg_c">
                            <input id="submitOrderID" type="submit" value="提交订单" class="hand btn136x36a"/>
                        </dd>
                    </dl>
                </div>
            </div>
