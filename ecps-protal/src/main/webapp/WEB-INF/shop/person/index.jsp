...
<div class="w loc">
	...
	<p class="l"><a href="${path}/item/toIndex.do" title="商城首页">商城首页</a><samp>|</samp><a href="${path}/user/login/toPersson.do" title="我的商城">我的商城</a></p>
	...
	<p class="r"><a href="${path}/item/toIndex.do" title="首页">首页</a><samp>&gt;</samp><span class="gray">用户中心</span></p>
...
<div class="w mt ofc">
	<div class="l wl">
		...
		<div class="box bg_gray">
			...
			<li><a href="${path}/user/login/deliverAddress.do" title="收货地址">收货地址</a></li>
		...
		<tbody>
			<tr>
				...
				<td class="nwp pic">
					<ul class="uls">
						<li>
							<a href="#" title="摩托罗拉ME525" class="pic"><img src="${path}/res/img/pic/p50x50.jpg" alt="摩托罗拉ME525" /></a>
							<dl>
