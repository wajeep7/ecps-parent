...
<head>
    ...
    <script type="text/javascript" src="${path}/res/shop/person/deliverAddress.js"></script>
...
<div class="w loc">
    ...
    <dl id="cart" class="cart l">
        ...
        <dd class="hidden">
            ...
            <ul class="uls">
                ...
                <li>
                    <a href="#" title="倍力通(Prestone)超级全合成机油5W-40 SM级 4L倍力通(Prestone)超级全合成机油5W-40 SM级 4L"><img
                            src="${path}/res/img/pic/p50x50c.jpg"
                            alt="倍力通(Prestone)超级全合成机油5W-40 SM级 4L倍力通(Prestone)超级全合成机油5W-40 SM级 4L"/></a>
                    <p class="dt"><a href="#" title="倍力通(Prestone)超级全合成机油5W-40 SM级 4L倍力通(Prestone)超级全合成机油5W-40 SM级 4L">倍力通(Prestone)超级全合成机油5W-40
                        SM级 4L倍力通(Prestone)超级全合成机油5W-40 SM级 4L</a></p>
                    <p class="dd">
    ...
    <p class="r"><a href="index.jsp" title="首页">首页</a><samp>&gt;</samp><a href="../person/index.jsp"
                                                                          title="用户中心">用户中心</a><samp>&gt;</samp><span
            class="gray">收货地址</span></p>
    ...
    <div class="r wr profile">
        <div class="confirm">
            ...
            <div class="ofc">
                ...
                <input type="hidden" id="addShipAddrRm" value="${fn:length(addrList)}">
                <table cellspacing="0" summary="" class="tab tab6">
                    ...
                    <c:forEach var="addr" items="${addrList}">
                        <tr <c:if test="${addr.defaultAddr ==1}"> class="here"</c:if>>
                            <td>${addr.shipName}</td>
                            <td>${addr.prevText}&nbsp;${addr.cityText}&nbsp;${addr.distText}</td>
                            <td>${addr.addr}</td>
                            <td>${addr.zipCode}</td>
                            <td>${addr.phone}</td>
                            <td class="def blue">设为默认</td>
                            <%--给shipAddr 表里的ID--%>
                            <td><a href="javascript:void(0);" title="修改" onclick="modifyAddr(${addr.shipAddrId})" class="blue">[修改]</a><a
                ...
                <form id="jvForm" action="${path}/user/saveOrUpdate.do" method="post">
                    <%--根据他来判断修改还是添加--%>
                    ...
                    <ul class="uls form">
                        ...
                        <li>
                            ...
                            <span class="bg_text">
                                <input type="text" id="shipName" name="shipName" vld="{required:true}" maxLength="100"/>
                            </span>
                        ...
                        <li>
                            <label for="province"><samp>*</samp>地　　址：</label>
...
\							</select>
                        ...
                        <li>    <%--地址--%>
                            ...
                            <span class="pos"><span class="tip errorTip">用户名为4-20位字母、数字或中文组成，字母区分大小写。</span>
                            </span>
                        </li>
                        ...
                        <li>
                            ...
                            <span class="bg_text">
                                <input type="text" id="zipCode" name="zipCode" maxLength="32" vld="{required:true}"/>
                            </span>
                        </li>
                        ...
                        <li>
                            ...
                            <span class="bg_text">
                                <input type="text" id="phone" name="phone" maxLength="32" vld="{required:true}"/>
                            </span>
                            <span class="pos">
