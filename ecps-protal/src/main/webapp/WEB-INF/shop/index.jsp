...
<div class="w loc">
	...
	<p class="l"><a href="#" title="商城首页">商城首页</a><samp>|</samp><a href="${path}/user/login/toPersson.do" title="我的商城">我的商城</a></p>

	<dl id="cart" class="cart l">
		<dt><a href="${path}/cart/selectCart.do" title="结算">结算</a>购物车:<b id="">123</b>件</dt>
		<dd class="hidden">
		...
		<div class="box bg_white">
			<ul class="uls x_50x50">
				<li>
					...
					<a href="#" title="张同来" target="_blank" class="pic"><img src="${path}/res/img/pic/p140X140b.png" alt="摩托罗拉XT319" /></a>
					<dl>
						<!-- dt 8个文字+... -->
	...
	<div class="r wr">
		...
		<div class="box bg_white">
			<ul class="uls i_150x150 x4_150x150">
				<li>
					<a href="./productDetail.jsp" title="张同来" target="_blank" class="pic"><img src="${path}/res/img/pic/p140X140b.png" alt="摩托罗拉XT319" /></a>
					<dl>
						<!-- dt 10个文字+... -->
		...
		<ul class="uls filter">
			<li><b>价格：</b><p>
				<a href="javascript:void(0);" ftype="skuprice" fvalue="" class="here">不限</a>
				<a href="javascript:void(0);" ftype="skuprice" fvalue="1-499">1-499</a>
				<a href="javascript:void(0);" ftype="skuprice" fvalue="500-999">500-999</a>
				<a href="javascript:void(0);" ftype="skuprice" fvalue="1000-1999">1000-1999</a>
				<a href="javascript:void(0);" ftype="skuprice" fvalue="2000-2999">2000-2999</a>
				<a href="javascript:void(0);" ftype="skuprice" fvalue="3000-3999">3000-3999</a>
				<a href="javascript:void(0);" ftype="skuprice" fvalue="4000-4999">4000-4999</a>
				<a href="javascript:void(0);" ftype="skuprice" fvalue="5000-1000000">5000以上</a>
			</p></li>
			...
			<li><b>商品搜索：</b><p>
				<input type="text" class="txt_sch gray" id="keyWords" name="keyWords" />
			</p></li>

			<c:forEach var="feature" items="${fList }">
				<li style="display:none"><b>${feature.featureName }：</b><p>
					<a href="javascript:void(0);" ftype="paraVals" fvalue="" class="here">不限</a>
					<c:forEach var="val" items="${feature.selectValues}">
						<a href="javascript:void(0);" ftype="paraVals" fvalue="${val}" >${val}</a>
					</c:forEach>
				</p></li>
			</c:forEach>
