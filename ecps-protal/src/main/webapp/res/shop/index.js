    ...
    $('.filter li a').mousedown(function(){
        ...
        $('.filter li a').each(function() {
            ...
            if(classes == "here") {
                ...
                if(ftype=="paraVals" && fvalue.length > 0) {
                    paraValues = paraValues + fvalue + ",";
                }
            }
        });

        var iPath = path+"/item/phoneClassification.do?skuprice="+skuprice+"&brandId="+brandId+"&keyWords="+keyWords+"&paraVals="+paraValues;
